            ...
            new Promise(async (resolve, reject) => {
                ...
                fetch("http://localhost:3006/api/generateOutfits", {
                    ...
                    .then((response) => {
                        if (!response.ok) {
                            throw new Error(
                                "Unable to access generate outfits api"
                            );
                        }
                    ...
                    .then((data) => {
                        ...
                        console.log(
                            responseText.recommendation1.outfitDescription
                        );
                        ...
                        const temp2 = [
                            {
                                ...
                                desc: responseText.recommendation1
                                    .outfitDescription,
                            },
                            {
                                id: 2,
                                img: data.imageUrls[1],
                                desc: responseText.recommendation2
                                    .outfitDescription,
                            },
                            {
                                id: 3,
                                img: data.imageUrls[2],
                                desc: responseText.recommendation3
                                    .outfitDescription,
                            },
                        ];
                    ...
                    .catch((error) => {
                        console.error(
                            "Error generating outfit recommendations:",
                            error
                        );
                        reject({

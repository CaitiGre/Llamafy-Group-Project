...
function LandingPage() {
  return (
    ...
    <div>
      ...
      <h2 className={styles.llamaSubheading}>No time for drama? Trust in Llama!</h2>
      <div
        className={styles.bottomSection}
        style={{ width: "cover", height: "700px", margin: "auto" }}>
        <div className={styles.aboutContainer}>
          ...
          <div className={styles.gifContainer} style={{
        ...
        <div className={styles.aboutContainer2}>
          <div className={styles.parallaxContainer} style={{

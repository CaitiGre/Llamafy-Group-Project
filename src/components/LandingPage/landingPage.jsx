...
function LandingPage() {
  ...
  return (
    ...
    <div>
      ...
      <Grid
        className={styles.bottomSection} flexDirection={"column"} height={"700px"} width={"100%"}>
        <Box display={"flex"} flexDirection={"row"} justifyContent={"space-evenly"} alignContent={"space-evenly"} margin={"auto"} padding={"35px"} width={"100%"} className={styles.aboutContainer}>
        <p>
          ...
          overwhelming day. Unlike other applications that can make suggestions
          surrounding potential wardrobe choices, LLAMAFY employs the use of
          artificial intelligence to account for your gender, general clothing
          preferences based on what you already have in your wardrobe, and the
          temperature of your home location. This way you can rest easy knowing
          you will not be suggested speedos when it is 10 degrees celcius
          outside! Amazing!
        </p>
        <Box
          className={styles.gifContainer} display={"flex"}
          style={{
        ...
        ></Box></Box>
        <Box
          className={styles.aboutContainer2} display={"flex"} flexDirection={"row"} justifyContent={"space-evenly"} alignContent={"space-evenly"} margin={"auto"} padding={"35px"} width={"100%"}
        >
          <Box
